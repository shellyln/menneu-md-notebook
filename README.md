...
https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/menneu.min.js  
https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/mkd+lsx.js  
https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/mkd.js  
https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/notebook.js  
...
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/mkd.js"></script>
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/menneu.min.js" onload="start({title: 'My Notebook 1'})"></script>
</body>
```
...
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/mkd+lsx.js"></script>
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/menneu.min.js" onload="start({title: 'My Notebook 1'})"></script>
</body>
```
...
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/notebook.js"></script>
<script src="https://cdn.jsdelivr.net/npm/menneu-md-notebook@0.0.12/articles/js/menneu.min.js" onload="start({title: 'My Notebook 1'})"></script>
</body>
```
